...
<div class="register-box">
  ...
  <div class="register-box-body">
    ...
    <form action="<?php echo base_url(); ?>index.php/c_login/simpan_register" method="post">
    ...
    <a href="<?php echo base_url(); ?>index.php/c_login/login" class="text-center">I already have a membership</a>
  </div>
  <!-- /.form-box -->
</div>
<!-- /.register-box -->
